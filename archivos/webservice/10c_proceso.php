<?
   ...
   echo "<br><br>Intento número: ".$_SESSION['CUENTA_INTENTOS_10'];
   ...
   echo "<br><br>";
	 ...
	 if($error_new_soap=="no error al crear soap")
	 {
	  ...
	  else
	  {
	     // SI hubo un error al crear new_soap:
           ...
           $aux_error="El Ministerio ha tardado más de ".$minutos_mensaje." minuto(s) en responder. <br><br>Por favor intente más tarde o presione <a href='10b_ini_contadores.php'>aqui</a> para intentarlo ya. <br><br>El programa ha suspendido su ejecución.";   
					 echo $aux_error;
					 exit;
			 }
			 else
    ...
    if(strlen(trim($cadena_xml->ingresoid))==0
       ...
       $aux_error="<br><br>Una vez hecha la corrección, puede presionar <a href='10b_ini_contadores.php'>aqui</a> para re-enviar.";   
		   echo $aux_error;
       exit;
